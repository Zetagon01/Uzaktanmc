...
public class GoblinSwampLeaveDecorator extends LeaveVineDecorator {

	public static final GoblinSwampLeaveDecorator INSTANCE = new GoblinSwampLeaveDecorator();
	...
	static {
		...
		tdt.setRegistryName("goblin_swamp_tree_leave_decorator");
