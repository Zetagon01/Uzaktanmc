...
package net.mcreator.thewonderland.world.features.lakes;
...
public class ChocolateFeature extends LakeFeature {
	public static ChocolateFeature FEATURE = null;
	public static Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new ChocolateFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("the_wonderland:chocolate", FEATURE, new LakeFeature.Configuration(
				BlockStateProvider.simple(TheWonderlandModBlocks.CHOCOLATE.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("the_wonderland:chocolate", CONFIGURED_FEATURE,
