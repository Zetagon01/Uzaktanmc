...
public class CandylandFruitDecorator extends CocoaDecorator {
	public static final CandylandFruitDecorator INSTANCE = new CandylandFruitDecorator();
	public static com.mojang.serialization.Codec<CandylandFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("candyland_tree_fruit_decorator");
