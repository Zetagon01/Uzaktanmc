package net.mcreator.thewonderland.client.model;
...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("the_wonderland", "modelcustom_model"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(4, 38).addBox(1.9758F, -3.6003F, -1.9967F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(27, 40).addBox(0.9758F, -2.0003F, -1.9967F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 38)
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(32, 5).addBox(-2.024F, 0.9997F, 0.0044F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.0436F, 0.0F));
		PartDefinition head_r1 = head.addOrReplaceChild("head_r1",
				CubeListBuilder.create().texOffs(18, 26).addBox(-2.0242F, -12.0003F, -0.9967F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 11.0F, -1.0F, 0.0F, 0.0F, 0.0F));
		PartDefinition ear2 = head.addOrReplaceChild("ear2",
				CubeListBuilder.create().texOffs(35, 35).addBox(3.0F, -1.0F, -0.1F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(29, 35)
						...
						.addBox(3.0F, -2.0F, -0.1F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(15, 26).addBox(3.0F, -1.0F, 1.0F, 2.0F, 1.0F,
		...
		PartDefinition horn2 = horn.addOrReplaceChild("horn2",
				CubeListBuilder.create().texOffs(40, 13).addBox(-1.9758F, -3.0003F, -2.0033F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(37, 37).addBox(-1.9758F, -6.0003F, -2.0033F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(33, 37)
		...
		PartDefinition jaw_r1 = jaw.addOrReplaceChild("jaw_r1",
				CubeListBuilder.create().texOffs(32, 8).addBox(-1.9249F, -0.0084F, -2.1271F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.043F, -0.0059F, 0.0045F));
		PartDefinition ear = head.addOrReplaceChild("ear",
				CubeListBuilder.create().texOffs(37, 11).addBox(3.0F, -1.0F, 0.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 36)
		...
		PartDefinition leftarm = partdefinition.addOrReplaceChild("leftarm",
				CubeListBuilder.create().texOffs(35, 40).addBox(0.0F, 1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(31, 40)
		...
		PartDefinition cube_r2 = leftarm.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(23, 37).addBox(-1.05F, 0.0F, -2.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 3)
		...
		PartDefinition rightarm = partdefinition.addOrReplaceChild("rightarm",
				CubeListBuilder.create().texOffs(24, 39).addBox(-1.0F, 1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(27, 32)
		...
		PartDefinition cube_r3 = rightarm.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(37, 15).addBox(-1.1F, 0.0F, -2.7F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 26).addBox(-3.0F, -14.0F, 0.0F, 6.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(39, 21)
		...
		PartDefinition rightleg = partdefinition.addOrReplaceChild("rightleg",
				CubeListBuilder.create().texOffs(16, 38).addBox(0.0F, 1.9962F, -2.0872F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 19)
						...
						.addBox(0.0F, 4.9962F, -1.0872F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 15).addBox(0.0F, 6.9962F, -4.0872F,
								1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 16.0F, 2.0F, 0.0873F, 0.0F, 0.0F));
		PartDefinition leftleg = partdefinition.addOrReplaceChild("leftleg",
				CubeListBuilder.create().texOffs(39, 18).addBox(-1.0F, 1.9962F, -2.0872F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(21, 32)
